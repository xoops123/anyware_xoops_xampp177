...
if ( !defined("XOOPS_MAINFILE_INCLUDED") ) {
    ...
    define('XOOPS_ROOT_PATH', 'Z:/xampp/htdocs/pack2011');
    ...
    define('XOOPS_TRUST_PATH', 'Z:/xampp/xoops_trust_path');

    // XOOPS Virtual Path (URL)
    // Virtual path to your main XOOPS directory WITHOUT trailing slash
    // Example: define('XOOPS_URL', 'http://localhost/pack2011');
    define('XOOPS_URL', 'http://localhost/pack2011');
