...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'db:d3pipes_block_sync.html', 5, false),array('modifier', 'nl2br', 'db:d3pipes_block_sync.html', 5, false),array('modifier', 'date', 'db:d3pipes_block_sync.html', 28, false),array('modifier', 'xugj_date', 'db:d3pipes_block_sync.html', 28, false),)), $this); ?>
...
?>
						...
						<li>
							<?php echo ((is_array($_tmp=((is_array($_tmp=@_MEDIUMDATESTRING)) ? $this->_run_mod_handler('date', true, $_tmp, $this->_tpl_vars['entry']['pubtime']+$this->_tpl_vars['timezone_offset']) : date($_tmp, $this->_tpl_vars['entry']['pubtime']+$this->_tpl_vars['timezone_offset'])))) ? $this->_run_mod_handler('xugj_date', true, $_tmp) : smarty_modifier_xugj_date($_tmp)); ?>
