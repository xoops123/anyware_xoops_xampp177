<?php /* Smarty version 2.6.26, created on 2012-09-01 07:19:40
         compiled from db:d3forum_comment_listposts_flat.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'db:d3forum_comment_listposts_flat.html', 29, false),)), $this); ?>
...
</div><?php endif; ?> --><!-- marine del 20120820 -->

<?php if ($this->_tpl_vars['pagenav']): ?><!-- marine add 20120820 -->
<div class="boxNavi" style="text-align:center;">
<ul class="itemBody">
<?php $_from = $this->_tpl_vars['pagenav']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['nav_']):
?>
<li class=<?php echo $this->_tpl_vars['nav_']['class']; ?>
><span>
<?php if ($this->_tpl_vars['nav_']['url']): ?><a href="<?php echo $this->_tpl_vars['nav_']['url']; ?>
#comment" title="go to page <?php echo $this->_tpl_vars['nav_']['txt']; ?>
"><?php echo $this->_tpl_vars['nav_']['txt']; ?>
</a>
<?php else: ?>
<?php echo $this->_tpl_vars['nav_']['txt']; ?>
...
<?php endif; ?><!-- /boxNavi --><!-- / marine add 20120820 -->
