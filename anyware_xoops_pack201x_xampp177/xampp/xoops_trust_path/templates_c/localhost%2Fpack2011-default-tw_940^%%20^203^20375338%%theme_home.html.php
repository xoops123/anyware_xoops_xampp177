<?php /* Smarty version 2.6.26, created on 2012-09-01 07:10:14
         compiled from tw_940/theme_home.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strstr', 'tw_940/theme_home.html', 5, false),array('modifier', 'xoops_blocktitleclassdel', 'tw_940/theme_home.html', 7, false),array('modifier', 'xoops_blocktitleclass', 'tw_940/theme_home.html', 22, false),)), $this); ?>
<header id="overview">
<div class="container">
	<h1><?php echo $this->_tpl_vars['xoops_sitename']; ?>
&nbsp;<small><?php echo $this->_tpl_vars['xoops_slogan']; ?>
&nbsp;<?php echo ''; ?><?php $_from = $this->_tpl_vars['xoops_ccblocks']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['ccloop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['ccloop']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['block']):
        $this->_foreach['ccloop']['iteration']++;
?><?php echo ''; ?><?php if (((is_array($_tmp=$this->_tpl_vars['block']['title'])) ? $this->_run_mod_handler('strstr', true, $_tmp, "[[") : strstr($_tmp, "[["))): ?><?php echo ''; ?><?php if (($this->_foreach['ccloop']['iteration'] <= 1)): ?><?php echo ''; ?><?php if (! ((is_array($_tmp=$this->_tpl_vars['block']['title'])) ? $this->_run_mod_handler('strstr', true, $_tmp, 'none') : strstr($_tmp, 'none'))): ?><?php echo ''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['block']['title'])) ? $this->_run_mod_handler('xoops_blocktitleclassdel', true, $_tmp) : smarty_modifier_xoops_blocktitleclassdel($_tmp)); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if (($this->_foreach['ccloop']['iteration'] <= 1)): ?><?php echo ''; ?><?php if (! ((is_array($_tmp=$this->_tpl_vars['block']['title'])) ? $this->_run_mod_handler('strstr', true, $_tmp, 'none') : strstr($_tmp, 'none'))): ?><?php echo ''; ?><?php echo $this->_tpl_vars['block']['title']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo ''; ?>
</small></h1>
...
<section id="level_1"><div class="container">
	<!-- h2 Heading from lbloop.first -->
...
<article id="main-content" class="home">
	<div class="container">
		<div class="row">
			<div class="span12"><?php echo $this->_tpl_vars['xoops_contents']; ?>
</div>
		</div>
	</div><!-- /container -->
</article>
